  ...
  return (
    <div className="inline-flex rounded-xl">
      <ul className="flex items-center">
        ...
        <li className="px-2">
          <button className="w-9 h-9 rounded-md border hover:border-yellow-700 hover:text-amber-500 text-amber-500">
            1
          </button>
        </li>
        <li className="px-2">
          <button className="w-9 h-9 rounded-md border hover:border-yellow-700 hover:text-amber-500">
            2
          </button>
        </li>
        <li className="px-2">
        ...
        <li className="px-2">
          <button
            aria-disabled="false"
            className="w-9 h-9 flex items-center justify-center rounded-md border hover:text-amber-500"
          >
            <span>
              <svg
                width="8"
